...
export const base = {
  ...
  type: "object",
  properties: {
    ocif: { type: "string", description: "The URI of the OCIF schema" },
    nodes: {
      type: "array",
  ...
  $defs: {
    node: {
      ...
      properties: {
        ...
        resource: { type: "string", description: "The resource to display" },
        resourceFit: {
          type: "string",
        ...
        data: { type: "array", description: "Extended node data" },
        rotation: { type: "number", description: "+/- 360 degrees" },
        relation: { type: "string", description: "ID of a relation" },
      },
      required: ["id"],
    },
    relation: {
...
export const core = {
  rectNode: {
    $schema: "https://json-schema.org/draft/2020-12/schema",
    title: "@ocif/node/rect",
    description: "Rectangle node extension",
    type: "object",
    properties: {
      type: { type: "string", const: "@ocif/node/rect" },
      strokeWidth: { type: "number", description: "The line width." },
      strokeColor: { type: "string", description: "The color of the stroke." },
